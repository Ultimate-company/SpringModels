package org.example.FactoryHelpers;
...
public class ProfileImageReplacedElementFactory implements ReplacedElementFactory {
    ...
    private final String divKey;
    public ProfileImageReplacedElementFactory(ReplacedElementFactory superFactory, byte[] imageBytes, String divKey) {
    ...
    public ReplacedElement createReplacedElement(LayoutContext layoutContext, BlockBox blockBox,
        ...
        if ("div".equals(nodeName) && className.contains(divKey)) {
